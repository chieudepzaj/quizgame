...
function printStyle() {
	...
	res += '<!--\n';
	//res += '  body {margin:0}\n';
	res += '  .mystyle {background-color: #66ff66; color: red;}\n';
...
function printHead(mm, yy) {
	...
	res += ('<td colspan="3" id="haha" class="tenthang">'+monthName+'</td>\n');
...
function printCell(lunarDate, solarDate, solarMonth, solarYear) {
	...
	number22=1;
	if (cellClass == "ngaythang") number22=2;
	else if (cellClass == "homnay") number22=3;
	else if (cellClass == "tet") number22=4;
	var res = "";
	var args = lunarDate.day + "," + lunarDate.month + "," + lunarDate.year + "," + lunarDate.leap;
	args += ("," + lunarDate.jd + "," + solarDate + "," + solarMonth + "," + solarYear);
	res += ('<td id="myDIV'+solarDate+'" class="'+cellClass+'"');
	if (lunarDate != null) res += (' title="'+getDayName(lunarDate)+'" onClick="myFunction('+solarDate+','+number22+')"');
	res += (' <div style=color:'+solarColor+' class="'+solarClass+'">'+solarDate+'</div> <div class="'+lunarClass+'">'+lunar+'</div></td>\n');
	return res;
}
ssvalue="trrr";
ssvalue2="trrr";
function myFunction(solarDate, number22) {
	if(ssvalue!="trrr"){
		document.getElementById(ssvalue).classList.remove("mystyle");
		document.getElementById(ssvalue).className += " " + ssvalue2;
	}

  var element, name, arr,test22;
  element = document.getElementById("myDIV"+solarDate.toString());
  name = "mystyle";
  arr = element.className.split(" ");
  //if (arr.indexOf(name) == -1) {
	if (number22==2) test22="ngaythang";
	else if (number22==3) test22="homnay";
	else if (number22==4) test22="tet";
	element.classList.remove(test22);
	// element.classList.remove("ngaythang");
	// element.classList.remove("tet");
	// element.classList.remove("homnay");
  element.className += " " + name;
	ssvalue = "myDIV"+solarDate.toString();
	ssvalue2= test22;
	var x = document.getElementById("haha").innerText;
	...
	document.getElementById("haha").innerHTML = solarDate+"/"+x;
//}
}
function printFoot() {
	var res = "";
